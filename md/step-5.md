...
# You're done!
Congratulations, you've made it to the end of all the tasks! You can either finish up now and save everything, or see some more tasks below. Feel free to show off what you've made today to us, we're always happy to see your spin on it. 😊 
...
- Make something silly. Here are some ideas to get started with:
    - Make it impossible for the player to survive past 2 seconds into the game.
    - Make the health bar cover the half the screen.
    - Replace all the textures with something silly.
    - Don't forget to revert your changes before carrying on!
...
- Add more spawnpoints to the JSON file, so enemies have more places to spawn.
- Import `data/map.json` and `images/tilemap.png` into [SpriteFusion](https://www.spritefusion.com/editor). Modify the level, and reimport it into the game.
...
Feel free to save up your project and load it onto a USB drive if you have it available. We also have `git` installed on these machines if you wish to push it to your own GitHub repository.
